...
class BecomeRealtor extends Component {
    constructor() {
        super();
    ...
    infoRequest(e) {
        ...
        if(name && email) {
            const infoRequest = {
                name: name,
                email: email,
                message: `Enviado desde formulario de ¿Eres o quieres ser corredor de bienes raíces?, ${startMessage} : ${message}`,
                timestamp: timestamp,
                status: 'pending'
            }
        ...
        return(
            <div>
                ...
                <section className="become-manager__header">
                    <h1>Registra tu empresa a nuestra red de corredores de bienes raíces</h1>
                </section>
                <section className="become-manager__benefits">
                    <h2>Beneficios para socios</h2>
                    <ul>
                        <li><i className="material-icons">play_arrow</i>Acceso completo a nuestra red de profesionales inmobiliarios</li>
                        ...
                        <li><i className="material-icons">play_arrow</i>Certificado de administración inmobiliaria WE MANAGE con manuales y formatos de procedimientos.</li>
                        ...
                        <li><i className="material-icons">play_arrow</i>Capacitación para utilizar sistema WE MANAGE</li>
                        ...
                        <li><i className="material-icons">play_arrow</i>Acceso a panel de licitaciones por propiedad</li>
                ...
                <section className="become-manager__price">
                    <div className="become-manager__price-middle">
                        <h2>¿Cómo registrar mi empresa en WE MANAGE?</h2>
                        <ol>
                            ...
                            <li>Completa el perfil de tu empresa y agrega a tu equipo de trabajo</li>
                    ...
                    <div className="become-manager__price-middle">
                        ...
                        <span>Regalías 8% de la comisión bruta cobrada + IVA</span>
